...
class TestBufferProperties:
    ...
    def test_concentration_roundtrip(self, vol: float, o2_kg: float, co2_kg: float, n2_kg: float) -> None:
    ...
    def test_mass_conservation_add(self, o2_add: float, co2_add: float, water_add: float) -> None:
